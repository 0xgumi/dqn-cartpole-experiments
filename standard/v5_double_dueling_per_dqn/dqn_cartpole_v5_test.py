...
CSV_FILE = os.path.join(BASE_DIR, "my_dqn_cartpole_v5_results.csv")
TXT_FILE = os.path.join(BASE_DIR, "my_dqn_cartpole_v5_results.txt")
...
def run_experiment(episodes=300, trials=50):
    ...
    for trial in range(trials):
        ...
        results.append([trial + 1, min_score, max_score, avg_score, round(std_dev, 2), reached_500])
        env.close()
